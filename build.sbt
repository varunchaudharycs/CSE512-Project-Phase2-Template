...
libraryDependencies ++= Seq(
  "org.apache.spark" %% "spark-core" % "2.2.0" % "provided", // provided(default) OR compile(to run in IDE)
  "org.apache.spark" %% "spark-sql" % "2.2.0" % "provided", // provided(default) OR compile(to run in IDE)
